...
namespace Randomizer.Framework.ViewModels.Commanding
{
    ...
    /// <summary>
    /// Allows to bind a method without parameters to a Command property of a Xamarin control by binding in XAML.
    /// </summary>
    public class SimpleCommand : ICommand
    {
        ...
        private void ChangeIsExecuting(object state)
        {
            ...
            _timer.Dispose();
            Device.BeginInvokeOnMainThread(() => _IsExecuting = false);
        }
