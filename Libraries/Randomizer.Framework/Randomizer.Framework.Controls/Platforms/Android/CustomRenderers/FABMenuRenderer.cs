...
using Clans.Fab;
using Randomizer.Framework.Controls;
using Randomizer.Framework.Controls.Platforms.Droid.CustomRenderers;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Resource = Randomizer.Framework.Controls.Resource;

[assembly: ExportRenderer(typeof(FABMenu), typeof(FABMenuRenderer))]
namespace Randomizer.Framework.Controls.Platforms.Droid.CustomRenderers
{
