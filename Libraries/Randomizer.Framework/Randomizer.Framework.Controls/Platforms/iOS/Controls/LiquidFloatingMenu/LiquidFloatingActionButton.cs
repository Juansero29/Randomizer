...
namespace Randomizer.Framework.Controls.iOS
{
    ...
    public class LiquidFloatingActionButton : UIControl
    {
        ...
        public event EventHandler<EventArgs> CellTapped;
        protected internal virtual void OnCellTapped()
        {
            CellTapped?.Invoke(this, EventArgs.Empty);
        }
        ...
        protected internal virtual void OnCellSelected(LiquidFloatingCell target)
        {
            ...
            if (handler != null)
            {
                handler(this, new CellSelectedEventArgs(target, target.Id));
            }
        }
